document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(type, param) {
      if (typeof ERROR_MESSAGES[type] === 'function') {
        return ERROR_MESSAGES[type](param);
      }
      return ERROR_MESSAGES[type] || 'Invalid value.';
    }
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (!VALIDATORS.minlength(value, minLen)) {
          showError(field, getErrorMessage('minlength', minLen));
          return false;
        }
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c4c65c67-85e8-46fb-b273-7d61c6ddeccb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c4c65c67-85e8-46fb-b273-7d61c6ddeccb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c4c65c67-85e8-46fb-b273-7d61c6ddeccb';
